...
export default function EvidenceSubmitForm({
  ...
  return (
    ...
    <div className="evidence-form-overlay">

      <div className="evidence-form-modal">

        {/* HEADER */}
        <div className="evidence-form-header">

          <div className="evidence-form-header-left">

            <h2 className="evidence-form-title">
              Nộp minh chứng
            </h2>

            <p className="evidence-form-subtitle">
